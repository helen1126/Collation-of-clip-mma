...
class CLIPTransformerAdapter(CLIPTransformerAdapterText):
    ...
    该类继承自CLIPTransformerAdapterText，在其基础上添加了一个基于Transformer块类型的掩码多头注意力下采样适配器。
    """

    def __init__(self, backbone: str = "ViT-B/16", root: str = "./data") -> None:
        """
        初始化CLIPTransformerAdapter类的实例。
        ...
        功能:
            ...
            2. 初始化一个MaskedMultiheadAttentionDownsampled类型的适配器，其块类型设置为 "transformer"。
        """
        # 将默认参数传递给父类
